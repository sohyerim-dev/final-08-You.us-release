...
import AddressInfo from '@/app/(with-layout)/(protected)/checkout/_components/AddressInfo';
import OrderItems from '@/app/(with-layout)/(protected)/checkout/_components/OrderItems';
import PaymentButton from '@/app/(with-layout)/(protected)/checkout/_components/PaymentButton';
import PaymentMethod from '@/app/(with-layout)/(protected)/checkout/_components/PaymentMethod';
import UserInfo from '@/app/(with-layout)/(protected)/checkout/_components/UserInfo';
